...
var _user$project$Main$initialModel = {
	messages: {
		ctor: '::',
		_0: _user$project$Main$Message('Hei'),
		_1: {
			ctor: '::',
			_0: _user$project$Main$Message('Dette er en test'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$Message('Lorem ipsum dolar sit amet'),
				_1: {ctor: '[]'}
			}
		}
	},
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'TextInput') {
			...
			var message = _user$project$Main$Message(model.textInput);
			return _elm_lang$core$Native_Utils.update(
				model,
				{
...
var _user$project$Main$AddMessage = {ctor: 'AddMessage'};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('MiniWoop'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder('Skriv inn melding'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$TextInput),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.textInput),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AddMessage),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"AddMessage":[],"TextInput":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
